...
@XmlType(name = "", propOrder = {"skapadTid", "info", "artikel"}) @XmlRootElement(name = "artiklar")
public class Artiklar {

  @XmlElement(name = "skapad-tid") protected String skapadTid;
  ...
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "") public static class Artikel {

    protected String nr;
    @XmlElement(name = "Artikelid") protected String artikelid;
    @XmlElement(name = "Varnummer") protected String varnummer;
    @XmlElement(name = "Namn") protected String namn;
    @XmlElement(name = "Namn2") protected String namn2;
    @XmlElement(name = "Prisinklmoms") protected String prisinklmoms;
    @XmlElement(name = "Pant") protected String pant;
    @XmlElement(name = "Volymiml") protected String volymiml;
    @XmlElement(name = "PrisPerLiter") protected String prisPerLiter;
    @XmlElement(name = "Saljstart") protected String saljstart;
    @XmlElement(name = "Slutlev") protected String slutlev;
    @XmlElement(name = "Varugrupp") protected String varugrupp;
    @XmlElement(name = "Typ") protected String typ;
    @XmlElement(name = "Forpackning") protected String forpackning;
    @XmlElement(name = "Forslutning") protected String forslutning;
    @XmlElement(name = "Ursprung") protected String ursprung;
    @XmlElement(name = "Ursprunglandnamn") protected String ursprunglandnamn;
    @XmlElement(name = "Producent") protected String producent;
    @XmlElement(name = "Leverantor") protected String leverantor;
    @XmlElement(name = "Argang") protected String argang;
    @XmlElement(name = "Provadargang") protected String provadargang;
    @XmlElement(name = "Alkoholhalt") protected String alkoholhalt;
    @XmlElement(name = "Modul") protected String modul;
    @XmlElement(name = "Sortiment") protected String sortiment;
    @XmlElement(name = "Ekologisk") protected String ekologisk;
    @XmlElement(name = "Koscher") protected String koscher;
    @XmlElement(name = "Etiskt") protected String etiskt;
    @XmlElement(name = "EtisktEtikett") protected String etisktEtikett;
    @XmlElement(name = "RavarorBeskrivning") protected String ravarorBeskrivning;
    ...
    public void setEtiskt(String value) {
      this.etiskt = value;
    }
  ...
  @XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "", propOrder = {"meddelande"})
